        ...
        <section class="max-w-[480px] p-4">
            <div class="flex flex-col justify-center items-center">
                ...
                <div class="text-center mt-4">
                    ...
                    <p v-if="user" class="text-textGrayDark text-sm" v-text="user.email" />
                </div>
            </div>
        </section>
        <section class="p-4">
            <div class="bg-white p-5 rounded-2xl">
                <div class="flex flex-col gap-5">
                    <template v-if="user">
                        <Link href="/profil" class="flex justify-between items-center group cursor-pointer">
                        ...
                        <Link href="/pengaturan-akun" class="flex justify-between items-center group cursor-pointer">
                            <p class="flex gap-6 text-textDark text-xl group-hover:text-primary duration-300">
                    ...
                    <template v-else>
                        <Link href="/daftar" class="flex justify-between items-center group cursor-pointer">
                            <p class="flex gap-6 text-textDark text-xl group-hover:text-primary duration-300">
                        ...
                        <Link href="/login" class="flex justify-between items-center group cursor-pointer">
                            <p class="flex gap-6 text-textDark text-xl group-hover:text-primary duration-300">
                    ...
                    <Link href="/pusat-bantuan" class="flex justify-between items-center group cursor-pointer">
                        <p class="flex gap-6 text-textDark text-xl group-hover:text-primary duration-300">
                    ...
                    <button v-if="user" type="button" class="ps-1 cursor-pointer" @click="openModal">
    ...
    <Transition name="scale">
        <div v-if="showModal"
            ...
            <div class="flex justify-between mt-4 gap-2">
                <button @click="closeModal" class="w-full text-secondary py-3 rounded-full font-medium cursor-pointer">
                    Batal
                </button>
