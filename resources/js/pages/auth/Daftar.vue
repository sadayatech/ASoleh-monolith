...
<template>
    <main class="bg-bgGray min-h-screen pb-24">
        ...
        <section>
            ...
            <form class="mt-4 p-4" @submit.prevent="submit">
                <h1 class="text-textDark text-center text-xl font-bold">
                    Daftar
                </h1>
                <div class="mt-4">
                    <label for="nama-lengkap" class="text-textDark">Nama Lengkap</label>
                    <div class="relative mt-2">
                        <input v-model="form.name" type="name" id="nama-lengkap"
                ...
                <div class="mt-4">
                    ...
                    <div class="relative mt-2">
                        <input v-model="form.whatsapp_number" type="number" id="nomor-whatsapp"
                            class="peer py-3 px-4 ps-12 block w-full bg-white rounded-full focus:outline-none"
                ...
                <div class="text-center text-sm mt-4">
                    <p>
                        Sudah punya akun?
                        <Link href="/login" class="text-secondary hover:underline">
                        Login
                        </Link>
                    </p>
                </div>
