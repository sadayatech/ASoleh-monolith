    ...
    <div class="bg-bgGray min-h-screen md:ps-[150px] p-4 md:pe-4 pt-[18px] pb-24 md:pb-0">
        <div class="bg-white p-4 rounded-2xl flex justify-between items-center">
            ...
            <div class="relative" ref="dropdownRef">
                ...
                <Transition name="fade">
                    <div v-if="isDropdownOpen" class="absolute right-0 z-10 mt-2 w-56 bg-white rounded-2xl shadow-lg">
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 md:gap-x-4">
                    <div v-for="supplier in $page.props.suppliers" @click="openModalDetail(supplier)" type="button"
                        ...
                        <div>
                            <h1 class="line-clamp-1 text-textDark font-semibold">{{ supplier?.name }}</h1>
                            <h2 class="text-textDark">{{ supplier?.whatsapp_number }}</h2>
                        </div>
                ...
                <div class="flex gap-4 mt-4">
                    <div class="text-start">
                        <div>
                            ...
                            <h1 class="text-textDark line-clamp-1">{{ selectedSupplier?.name }}</h1>
                        </div>
                        <div class="mt-2">
        ...
        <Transition name="scale">
            <div v-if="showModalHapus"
                ...
                <div class="">
                    <p class="text-center text-textDark text-xl font-semibold">Apakah Anda yakin ingin menghapus
                        supplier ini?</p>
                </div>
                <div class="flex justify-between mt-4 gap-2">
            ...
            <div v-if="showModalKeluar"
                ...
                <div class="flex justify-between mt-4 gap-2">
                    <button @click="closeModalKeluar"
                        class="w-full text-secondary py-3 rounded-full font-medium cursor-pointer">Batal</button>
                    <button
                        class="w-full bg-primary text-textDark py-3 rounded-full font-medium cursor-pointer hover:brightness-90 duration-300">Keluar</button>
                </div>
            </div>
        </Transition>
