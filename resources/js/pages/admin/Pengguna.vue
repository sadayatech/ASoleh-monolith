          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
            ...
            <div class="col-span-1">
              ...
              <div class="relative mt-2">
                <input
                  type="tel"
                  id="nomor-whatsapp"
                  v-model="createUserForm.whatsapp_number"
                  class="peer py-3 px-4 ps-12 block w-full bg-white rounded-full focus:outline-none"
            ...
            <div class="col-span-1">
              ...
              <div class="relative mt-2">
                <input
                  type="date"
                  v-model="createUserForm.tanggal_lahir"
                  id="tanggal-lahir"
            ...
            <div class="col-span-1">
              ...
              <div class="relative mt-2">
                <select
                  id="jenis-kelamin"
                  v-model="createUserForm.jenis_kelamin"
                  class="peer py-3 px-4 ps-12 block w-full bg-white rounded-full focus:outline-none appearance-none cursor-pointer"
                  required
                >
            ...
            <div class="col-span-1">
              ...
              <div class="relative mt-2">
                <input
                  ...
                  id="password"
                  class="peer py-3 px-4 ps-12 block w-full bg-white rounded-full focus:outline-none"
                  placeholder="Masukkan Sandi Pengguna"
            ...
            <div class="col-span-1">
              ...
              <div class="relative mt-2">
                <input
                  type="tel"
                  id="nomor-whatsapp"
                  v-model="editUserForm.whatsapp_number"
                  class="peer py-3 px-4 ps-12 block w-full bg-white rounded-full focus:outline-none"
                  placeholder="Masukkan Nomor WhatsApp"
                  required
                />
            ...
            <div class="col-span-1">
              ...
              <div class="relative mt-2">
                <input
                  type="date"
                  id="tanggal-lahir"
                  v-model="editUserForm.tanggal_lahir"
                  class="peer py-3 px-4 ps-12 block w-full bg-white rounded-full focus:outline-none appearance-none"
                  required
                />
                <div
            ...
            <div class="col-span-1">
              ...
              <div class="relative mt-2">
                <select
                  id="jenis-kelamin"
                  class="peer py-3 px-4 ps-12 block w-full bg-white rounded-full focus:outline-none appearance-none cursor-pointer"
                  v-model="editUserForm.jenis_kelamin"
                  required
                >
                  <option value="placeholder" disabled selected>
                    Pilih Jenis Kelamin
