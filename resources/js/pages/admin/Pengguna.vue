        ...
        <section class="mt-6">
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-x-4">
                    <div
                        v-for="userL in $page.props.users"
                        @click="openModalDetail(userL)"
                        class="relative col-span-1 bg-white p-6 mt-4 rounded-3xl flex items-center gap-4 text-start cursor-pointer"
                    >
                        <!-- Badge -->
                        <div
                            class="absolute top-0 right-0 bg-primaryThin py-1.5 px-4 rounded-tr-3xl rounded-bl-3xl"
                        >
                            <p
                                class="text-sm text-primary font-medium capitalize"
                            >
                                {{ userL.role }}
                            </p>
                        </div>
                ...
                <div class="flex gap-4 mt-4">
                    <div class="text-start w-full">
                        <div class="flex flex-col justify-center items-center">
                            <div
                                class="h-32 w-32 rounded-full overflow-hidden relative"
                            >
                        ...
                        <div
                            class="grid grid-cols-1 md:grid-cols-2 mt-6 gap-y-4"
                        >
                            <div class="">
            ...
            >
                ...
                >
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                        ...
                        <!-- Nama Pengguna -->
                        <div class="col-span-1">
                            <label for="nama-pengguna" class="text-textDark"
                                >Nama Pengguna</label
                            >
                            <div class="relative mt-2">
                                <input
                        ...
                        <!-- Email -->
                        <div class="col-span-1">
                            <label for="email" class="text-textDark"
                                >Alamat Email</label
                            >
                            <div class="relative mt-2">
                                <input
                        ...
                        <!-- Peran -->
                        <div class="col-span-1">
                            <label for="peran-pengguna" class="text-textDark"
                            ...
                            <div class="relative mt-2">
                                ...
                                >
                                    <i
                                        class="fi fi-rr-user-gear text-textDark text-xl"
                                    ></i>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- Tanggal Lahir -->
                        <div class="col-span-1">
                            <label for="tanggal-lahir" class="text-textDark"
                                >Tanggal Lahir</label
                            >
                            <div class="relative mt-2">
                                <input
                                ...
                                >
                                    <i
                                        class="fi fi-rr-calendar text-textDark text-xl"
                                    ></i>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- Jenis Kelamin -->
                        <div class="col-span-1">
                            <label for="jenis-kelamin" class="text-textDark"
                                >Jenis Kelamin</label
                            >
                            <div class="relative mt-2">
                                <select
                                ...
                                >
                                    <i
                                        class="fi fi-rr-mars text-textDark text-xl"
                                    ></i>
                                </div>
                            </div>
                        </div>
