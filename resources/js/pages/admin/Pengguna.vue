...
<template>
    <div class="bg-bgGray min-h-screen md:ps-[150px] p-4 md:pe-4 pt-[18px] pb-24 md:pb-0">
        ...
        <!-- Modal Tambah Pengguna -->
        <Transition name="scale">
            <div v-if="showModalTambah" ref="tambahRef" class="fixed inset-0 z-30 overflow-y-auto flex justify-center items-start">
        ...
        <!-- Modal Ubah Pengguna -->
        <Transition name="scale">
            <div v-if="showModalUbah" ref="ubahRef" class="fixed inset-0 z-30 overflow-y-auto flex justify-center items-start">
                <div class="bg-bgGray w-[90%] md:w-[60%] p-4 md:py-8 md:px-6 rounded-4xl shadow-lg mt-10 mb-10">
                    <div class="flex justify-between">
                        <h1 class="text-textDark text-lg font-semibold">
                            Ubah Pengguna
