...
<template>
    <main class="bg-bgGray min-h-screen pb-20">
        ...
        <section class="mt-2 p-4">
            ...
            <div class="mt-4">
                <label for="nama-pemesan" class="text-textDark">Nama Pemesan <span
                        class="text-secondary">*</span></label>
                <div class="relative mt-2">
                    <input type="name" v-model="form.consumer_name" id="nama-pemesan"
            ...
            <div class="mt-4">
                <label for="email-pemesan" class="text-textDark">Email Pemesan <span
                        class="text-secondary">*</span></label>
                <div class="relative mt-2">
                    <input type="email" v-model="form.email" id="email-pemesan"
                        class="peer py-3 px-4 ps-12 block w-full bg-white rounded-full focus:outline-none"
            ...
            <div class="mt-4">
                <label for="nomor-whatsapp" class="text-textDark">Nomor WhatsApp <span
                        class="text-secondary">*</span></label>
                <div class="relative mt-2">
                    <input type="tel" id="nomor-whatsapp" v-model="form.whatsapp_number"
                        class="peer py-3 px-4 ps-12 block w-full bg-white rounded-full focus:outline-none"
                        placeholder="Contoh: 6281234567891" required />
                    <div class="absolute inset-y-0 start-0 flex items-center pointer-events-none ps-4 pt-1">
                        <p class="text-textDark text-xl">
        ...
        <section class="mt-2 p-4">
            ...
            <div class="mt-4">
                ...
                <div class="relative mt-2">
                    <input type="text" v-model="form.notes" id="catatan"
                        class="peer py-3 px-4 ps-12 block w-full bg-white rounded-full focus:outline-none"
