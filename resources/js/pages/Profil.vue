  ...
  <div class="bg-bgGray min-h-screen pb-4">
    <section class="bg-primary w-full p-4">
      <div class="flex items-center">
        <p class="text-2xl translate-y-0.5 cursor-pointer" @click="goBack">
          <i class="fi fi-rr-arrow-left"></i>
        </p>
        <h1 class="text-lg font-semibold absolute left-1/2 -translate-x-1/2">
          Profil Saya
        </h1>
      </div>
    </section>
      ...
      <div class="mt-4">
        ...
        <div class="relative mt-2">
          ...
          <label for="uploadFotoProfil"
            ...
            <span class="bg-bgGray py-3 px-4 rounded-l-2xl text-textDark w-[50%]">Choose File</span>
      ...
      <div class="mt-4">
        ...
        <div class="relative mt-2">
          <input type="date" v-model="form.tanggal_lahir" id="tanggal-lahir"
            class="peer py-3 px-4 ps-12 block w-full bg-white rounded-2xl focus:outline-none appearance-none"
            required />
      ...
      <div class="mt-4">
        ...
        <div class="relative mt-2">
          <select id="jenis-kelamin" v-model="form.jenis_kelamin"
            class="peer py-3 px-4 ps-12 block w-full bg-white rounded-2xl focus:outline-none appearance-none" required>
