                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                    <button v-for="order in $page.props.orders" @click="openModalDetail(order)"
                        ...
                        <div class="absolute top-0 right-0 bg-primaryThin py-1.5 px-4 rounded-tr-2xl rounded-bl-2xl">
                            <p class="text-sm text-primary font-medium">{{ order.consumer_name }}</p>
                        </div>
                        <div class="flex justify-between">
                            <div class="text-start">
                                <h2 class="text-textDark font-semibold">{{ order.transaction_code }}</h2>
                                <p class="text-textDark text-sm">{{ new Date(order.created_at).toLocaleString('id-ID')
                                }}</p>
                            </div>
                        </div>
                        <div class="flex justify-between">
                            ...
                            <div class="text-end">
                                ...
                                <p class="text-textDark text-sm">
                                    {{order.items.reduce((sum, item) => sum +
                                        item.quantity, 0)}} Item</p>
                            </div>
                        </div>
                    </button>
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="space-y-4 mt-4">
                                <div>
                                    ...
                                    <div class="relative mt-2">
                                        <div class="py-3 px-4 ps-12 bg-white rounded-full">
                                            <p class="text-textDark">{{ ORDER.consumer_name || "N/A" }}</p>
                                        </div>
                                        <div
                                ...
                                <div>
                                    ...
                                    <div class="relative mt-2">
                                        <div class="py-3 px-4 ps-12 bg-white rounded-full">
                                            <p class="text-textDark">{{ ORDER.whatsapp_number || "N/A" }}</p>
                                        </div>
                                        <div
                                            class="absolute inset-y-0 start-0 flex items-center pointer-events-none ps-4 pt-1">
                            ...
                            <div class="mt-4">
                                <div class="bg-white mt-4 p-4 rounded-2xl space-y-2">
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <p class="text-green">{{ konversiStatus(ORDER.status) }}</p>
                                    </div>
                                    <div class="flex justify-between">
                                        <p class="text-textDark">Metode Pembayaran</p>
                                        <p class="text-textDark uppercase">{{ ORDER.payment_method }}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div
                                ...
                                <div v-for="i in ORDER.items" class="flex justify-between items-center">
                                    <div>
                                        ...
                                        <h2 class="font-bold">Rp{{ Number(i.item.price).toLocaleString('id-ID') }}</h2>
                                    </div>
