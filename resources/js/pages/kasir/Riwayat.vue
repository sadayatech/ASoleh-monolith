        ...
        <section class="mt-6">
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                    <button @click="openModalDetail" class="relative block bg-white p-4 space-y-5 rounded-2xl hover:bg-primaryThin duration-300 cursor-pointer">
                        <!-- Badge -->
                        <div class="absolute top-0 right-0 bg-primaryThin py-1.5 px-4 rounded-tr-2xl rounded-bl-2xl">
                            <p class="text-sm text-primary font-medium">Nama Customer</p>
                        </div>
