        ...
        >
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
            ...
            <div class="col-span-1">
                ...
                <div>
                  ...
                  <div class="relative mt-2">
                    <div class="py-3 px-4 ps-12 bg-white rounded-full">
                      <p
                        class="text-textDark"
                        v-text="ORDER.customer_name || 'N/A'"
                      ></p>
                    </div>
                    <div
                ...
                <div>
                  ...
                  <div class="relative mt-2">
                    <div class="py-3 px-4 ps-12 bg-white rounded-full">
                      <p
                        class="text-textDark"
                        v-text="ORDER.whatsapp_number || 'N/A'"
                      ></p>
                    </div>
                    <div
                      class="absolute inset-y-0 start-0 flex items-center pointer-events-none ps-4 pt-1"
              ...
              <button
                v-if="String(ORDER.status) == 'under-review'"
            ...
            <Transition name="scale">
              <div
                ...
                v-if="previewImage && ORDER.status == 'under-review'"
